...
def test_shell(completion):
    ...
    completion.assert_called_once_with(**comp_args(role, args["prompt"], model=cfg.get("GEMINI_EXECUTION_MODEL", "gemini/gemini-flash-latest")))
...
def test_shell_stdin(completion):
    ...
    completion.assert_called_once_with(**comp_args(role, expected_prompt, model=cfg.get("GEMINI_EXECUTION_MODEL", "gemini/gemini-flash-latest")))
...
def test_describe_shell(completion):
    ...
    completion.assert_called_once_with(**comp_args(role, args["prompt"], model=cfg.get("GEMINI_LIGHTWEIGHT_MODEL", "gemini/gemini-flash-lite-latest")))
...
def test_describe_shell_stdin(completion):
    ...
    expected_prompt = f"{stdin}"
    completion.assert_called_once_with(**comp_args(role, expected_prompt, model=cfg.get("GEMINI_LIGHTWEIGHT_MODEL", "gemini/gemini-flash-lite-latest")))
    assert result.exit_code == 0
    assert "lists" in result.output
...
def test_shell_chat(completion):
    ...
    expected_args = comp_args(role, "", messages=expected_messages, model=cfg.get("GEMINI_EXECUTION_MODEL", "gemini/gemini-flash-latest"))
