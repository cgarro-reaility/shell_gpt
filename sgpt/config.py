...
DEFAULT_CONFIG = {
    ...
    "DEFAULT_MODEL": os.getenv("DEFAULT_MODEL", "gemini-pro-latest"),
    "GEMINI_REASONING_MODEL": os.getenv("GEMINI_REASONING_MODEL", "gemini-pro-latest"),
    "GEMINI_EXECUTION_MODEL": os.getenv("GEMINI_EXECUTION_MODEL", "gemini-flash-latest"),
    "GEMINI_LIGHTWEIGHT_MODEL": os.getenv("GEMINI_LIGHTWEIGHT_MODEL", "gemini-flash-lite-latest"),
